...
class Controller extends BaseController
{
	   ...
	   protected function obtenerAccessToken()
    {
    	...
    	$respuesta = json_decode($this->realizarPeticion('POST', 'http://agroproduccion.com:8889/oauth/access_token', ['form_params' => ['grant_type' => $grantType, 'client_id' => $clientId, 'client_secret' => $clientSecret]]));
